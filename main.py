...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", type=str, default='pi_deeponet_Ldata', help="Available methods are  'pi_deeponet_Ldata', 'pi_deeponet', 'modified_pi_deeponet_Ldata', 'modified_pi_deeponet'.")
